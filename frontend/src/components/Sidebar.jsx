...
export default function Sidebar() {
  return (
    <aside className='sticky top-0 hidden min-h-screen w-72 flex-col justify-between border-r border-slate-200 bg-white p-5 lg:flex'>
      <div>
        <img src='https://www.bits-pilani.ac.in/wp-content/themes/bits/assets/images/bitspilani-logo.png' alt='BITS Pilani logo' className='mb-3 h-12 object-contain' />
        <h1 className='mb-8 text-2xl font-bold text-[#4F46E5]'>CampusHub</h1>
      ...
      <div className='rounded-xl border border-slate-200 bg-slate-50 p-3'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            ...
            <p className='text-xs text-slate-500'>BITS Pilani Community</p>
          </div>
        </div>
      </div>
    </aside>
